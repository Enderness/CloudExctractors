...
<body class="sidebar-dark" data-gr-c-s-loaded="true" cz-shortcut-listen="true">      
	<div class="main-wrapper">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
          <div>
            <h4 class="mb-3 mb-md-0">Welcome, <?php user::getUser("username");?><h4>
          </div>
        </div>
            ...
            <div class="row flex-grow">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-baseline">
                      <h6 class="card-title mb-0">Serial Keys</h6>
                    </div>
                    <div class="row">
                      <div class="col-6 col-md-12 col-xl-5">
                        <h3 id="serial_keys_amount" class="mb-2"></h3>
                      </div>
                      <div class="col-6 col-md-12 col-xl-7">
                        <div id="apexChart1" class="mt-md-3 mt-xl-0" style="min-height: 60px;"></div>
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-baseline">
                      <h6 class="card-title mb-0">Trials</h6>
                    </div>
                    <div class="row">
                      <div class="col-6 col-md-12 col-xl-5">
                        <h3 id="trials_amount" class="mb-2"></h3>
                      </div>
                      <div class="col-6 col-md-12 col-xl-7">
                        <div id="apexChart2" class="mt-md-3 mt-xl-0" style="min-height: 60px;"></div>
                      </div>
                    </div>
                  </div>
                </div>
  ...
  <script src="./NobleUI Responsive Bootstrap 4 Dashboard Template_files/bootstrap-datepicker.min.js"></script>
  <script src="js/apexcharts.min.js"></script>
  <script src="js/template.js"></script>
  <script src="./NobleUI Responsive Bootstrap 4 Dashboard Template_files/progressbar.min.js"></script>
	<!-- end plugin js for this page -->
	<!-- inject:js -->
	<script src="./NobleUI Responsive Bootstrap 4 Dashboard Template_files/feather.min.js"></script>
	<!-- endinject -->
...
{ 
  ...
  $then = time()-$day*$i;
  $now = time()+1-$day*($i-1);
  $query = $db->query("SELECT started_at FROM trials WHERE started_at BETWEEN ? AND ?", $then, $now);
  array_push($data, $query->rowCount());
}
  $data = array_reverse($data);
?>
