                ...
                <table id="dataTableExample" class="table dataTable no-footer" role="grid" aria-describedby="dataTableExample_info">
                  <thead>
                    <tr role="row">
                      ...
                      <th class="sorting" tabindex="0" aria-controls="dataTableExample" rowspan="1" colspan="1"  style="width: 403px;">Serial Key</th>
                      <th class="sorting_asc" tabindex="0" aria-controls="dataTableExample" rowspan="1" colspan="1" aria-sort="ascending"  style="width: 263px;">Last ip</th>
                      <th class="sorting_asc" tabindex="0" aria-controls="dataTableExample" rowspan="1" colspan="1" aria-sort="ascending"  style="width: 263px;">Country</th>
                      <th class="sorting" tabindex="0" aria-controls="dataTableExample" rowspan="1" colspan="1"  style="width: 194px;">Status</th>
                      <th class="sorting" tabindex="0" aria-controls="dataTableExample" rowspan="1" colspan="1"  style="width: 190px;">Created at</th>
                      <th class="sorting" tabindex="0" aria-controls="dataTableExample" rowspan="1" colspan="1" style="width: 150px;">Expires at</th>
                      <th class="sorting" tabindex="0" aria-controls="dataTableExample" rowspan="1" colspan="1"  style="width: 150px;">Manage</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
