    ...
    <ul class="nav">
        ...
        <li class="nav-item nav-category">Serial Keys</li>
        <li class="nav-item">
        <a class="nav-link" href="addkey">
            ...
            <span class="link-title">Add serial key</span>
        </a>
        </li>

        <li class="nav-item">
        <a class="nav-link" href="changekey" >
            ...
            <span class="link-title">Change key status</span>
        </a>
        </li>        
        <?php 
        if(user::rankIsMax(1))
        ...
        <a class="nav-link" href="keylist">
            ...
            <span class="link-title">Manage Keys</span>
        </a>
        </li>
        <li class="nav-item nav-category">Trials</li>
        <li class="nav-item">
        <a class="nav-link" href="trialslist">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-inbox link-icon"><polyline points="22 12 16 12 14 15 10 15 8 12 2 12"></polyline><path d="M5.45 5.11L2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"></path></svg>
            <span class="link-title">Manage Trials</span>
        </a>
        </li>
        ...
        <a class="nav-link" href="/apps/">
            ...
            <span class="link-title">Cloud Extractors</span>
        </a>
        </li>
        <?php } ?>
    </ul>
